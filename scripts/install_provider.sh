#!/bin/sh
# Install the BetterLyrics provider into the running Music Assistant container.
#
# Usage:
...
REPO_NAME="music-assistant-betterlyrics"
PROVIDER_DIR="better_lyrics"
...
Options:
  ...
  --python-version VER      MA Python version, e.g. python3.14 (default: auto-detect)
